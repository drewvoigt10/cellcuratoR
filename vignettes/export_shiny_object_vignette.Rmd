...
# In instances where there are multiple factor levels to a biological condition (eg early, mid, late disease
# stage), the user is encouraged to create seperate columns in the meta.data for each comparison of 
# interest (eg early vs late, ealy vs mid, mid vs late), and specifying all of these column names
# in the additional_metadata_cols argument listed below.
...
```{r export_obj, message = FALSE, warning = FALSE}
